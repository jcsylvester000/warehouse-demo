...
const doc1 = [
  ...
  H1("Quality check"),
  P("All automated checks pass: 8 test suites totalling 209 checks, including a strict amendment suite run three times (47 checks each pass, 0 failures). The production build is clean."),
];
